...
// Function for setting the framework/plugin used to create the slideshow.
var SlideFramework = function(framework) {
  var framework_path = path.join(__dirname, "frameworks", framework);
